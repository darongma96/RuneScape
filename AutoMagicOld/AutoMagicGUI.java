 ...
 * @author Da Rong
 */
public class AutoMagicGUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (jTabbedPane1.getSelectedIndex() == 4) {
        	mode = "enchant";
        	//itemToEnchant = jComboBox4.getSelectedItem().toString() + " " + jComboBox5.getSelecetedItem().toString();
        	//spellToCast = jComboBox6.getSelectedItem().toString();	
        }
        gui_complete = true;
